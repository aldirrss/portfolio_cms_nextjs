...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="hero-orb absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full opacity-10"
        style={{
          background:
            "radial-gradient(circle, rgba(191,0,255,0.4) 0%, rgba(0,128,255,0.2) 40%, transparent 70%)",
        }}
      />
      <canvas
        ref={canvasRef}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="order-2 lg:order-1 flex-1 text-center lg:text-left">
            ...
            >
              ...
              <span className="font-mono text-base text-neon-cyan">
                <TypeAnimation
                  sequence={profile.typingRoles as (string | number)[]}
                  speed={50}
                  repeat={Infinity}
                />
              </span>
            ...
            >
              Building <span className="text-neon-cyan">scalable</span> ERP
              backends, integration flows, and business-critical systems.
              Passionate about clean code and{" "}
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="btn-primary relative z-10 inline-flex items-center justify-center gap-2"
                data-hover
              >
            ...
            >
              {profile.stats.map((stat) => (
                <div key={stat.label} className="text-center">
                  ...
                  <div className="font-mono text-xs text-slate-500 tracking-widest mt-1">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          >
            <div className="relative w-64 h-64 sm:w-80 sm:h-80">
              ...
              <div
                className="absolute -inset-8 rounded-full border border-neon-cyan/10"
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(191,0,255,0.4), rgba(0,255,255,0.4))",
                  padding: "3px",
                }}
              >
              ...
              >
                <div className="font-mono text-xs text-neon-purple">
                  Programmer
                </div>
                <div className="font-mono text-[10px] text-slate-500">
                  Odoo • Engineer
