...
export default function ContactSection({
  ...
  return (
    <section className="relative py-16 lg:py-24 overflow-hidden">
      ...
      <div
        className="absolute bottom-0 left-1/4 w-96 h-96 rounded-full opacity-5 pointer-events-none"
          ...
          >
            <div className="glass-card p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="font-mono text-xs text-slate-500 ml-2">
                  contact.form
                </div>
              </div>
              ...
              {sent ? (
                ...
                >
                  ...
                  <div className="font-display text-xl font-bold gradient-text mb-2">
                    Message Sent!
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label className="block font-mono text-[10px] text-slate-500 tracking-widest uppercase mb-2">
                      // Name
                    </label>
                    <input
                      type="text"
